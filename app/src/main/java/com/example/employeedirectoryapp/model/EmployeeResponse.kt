package com.example.employeedirectoryapp.model
...
data class EmployeeResponse(
    @field:Json(name = "employees") val employees: List<EmployeeGroupedItem.Employee>
)

sealed class EmployeeGroupedItem {
    data class Header(
        val team: String? = ""
    ) : EmployeeGroupedItem()
